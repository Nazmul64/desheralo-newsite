...
<div class="container-fluid px-4 py-5">
    ...
    @if(session('success'))
        <div class="alert-toast d-flex align-items-center gap-3 mb-4 px-4 py-3">
            ...
            <button type="button" class="toast-close ms-auto" data-bs-dismiss="alert">
    ...
    <div class="page-header d-flex align-items-center justify-content-between mb-5">
        <div>
            ...
            <h1 class="page-title mb-0">Edit Page Settings</h1>
        </div>
    ...
    <div class="settings-layout">
        ...
        <aside class="settings-sidebar">
            ...
            <p class="sidebar-hint mt-3">Each section saves independently.</p>
        </aside>
        ...
        <main class="settings-content">
            ...
            <div class="section-panel" id="panel-home_one" style="{{ $active !== 'home_one' ? 'display:none' : '' }}">
                ...
                <form action="{{ route('managepage.update', [$page->id, 'section' => 'home_one']) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="form-grid">
                        @php
                            $homeOneFields = [
            ...
            <div class="section-panel" id="panel-home_two" style="{{ $active !== 'home_two' ? 'display:none' : '' }}">
                ...
                <form action="{{ route('managepage.update', [$page->id, 'section' => 'home_two']) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="form-grid">
                        @php
                            $homeTwoFields = [
            ...
            <div class="section-panel" id="panel-menu_title" style="{{ $active !== 'menu_title' ? 'display:none' : '' }}">
                ...
                <form action="{{ route('managepage.update', [$page->id, 'section' => 'menu_title']) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="form-grid">
                        @php
                            $menuFields = [
            ...
            <div class="section-panel" id="panel-all_pages" style="{{ $active !== 'all_pages' ? 'display:none' : '' }}">
                ...
                <form action="{{ route('managepage.update', [$page->id, 'section' => 'all_pages']) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="form-grid">
                        @php
                            $allPageFields = [
            ...
            <div class="section-panel" id="panel-contact_us" style="{{ $active !== 'contact_us' ? 'display:none' : '' }}">
                ...
                <form action="{{ route('managepage.update', [$page->id, 'section' => 'contact_us']) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="form-grid">
                        @php
                            $contactFields = [
            ...
            <div class="section-panel" id="panel-footer_section" style="{{ $active !== 'footer_section' ? 'display:none' : '' }}">
                ...
                <form action="{{ route('managepage.update', [$page->id, 'section' => 'footer_section']) }}" method="POST">
                    @csrf @method('PUT')
                    <div class="form-grid">
                        @php
                            $footerFields = [
...
<style>
/* ── Toast ── */
.alert-toast { background:#f0fdf4; border:1px solid #bbf7d0; border-radius:10px; color:#15803d; font-size:14px; }
.toast-close { background:none; border:none; cursor:pointer; color:#16a34a; padding:0; }
...
.sidebar-hint { font-size:11.5px; color:#9ca3af; text-align:center; }
...
.has-error .field-input:focus { box-shadow:0 0 0 3px rgba(239,68,68,.12); }
.field-error { font-size:12px; color:#ef4444; }

/* ── Actions ── */
.form-actions { border-top:1px solid #f3f4f6; padding-top:20px; }
.btn-submit {

...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <span class="cmsh-form-page-title">Edit Header</span>
    ...
    <div class="cmsh-form-card card">
        <div class="card-body">
            <form action="{{ route('cmsheader.update', $cmsheader->id) }}" method="POST" enctype="multipart/form-data">
                @csrf @method('PUT')
                    ...
                    <div class="col-lg-6">
                        ...
                        @if($cmsheader->image)
                            <div class="cmsh-current-img">
                                ...
                                <img src="{{ asset($cmsheader->image) }}" alt="{{ $cmsheader->name }}">
                            </div>
                        @endif
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="cmsh-select-wrap">
                            <select class="cmsh-select" name="name" required>
                                ...
                                @for($i = 1; $i <= 7; $i++)
                                    <option value="Header {{ $i }}" {{ $cmsheader->name == "Header $i" ? 'selected' : '' }}>
                                        Header {{ $i }}
                                    </option>
                                @endfor
                            </select>

...
<style>
    ...
    .cmsh-upload-zone:hover .cmsh-upload-icon {
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <span class="cmsh-form-page-title">Create Header</span>
        <a href="{{ route('cmsheader.index') }}" class="cmsh-list-btn">
            <i class="bi bi-list-ul"></i> Header List
        </a>
    </div>

    <div class="cmsh-form-card card">
        <div class="card-body">
            <form action="{{ route('cmsheader.store') }}" method="POST" enctype="multipart/form-data" id="createForm">
                @csrf
                ...
                <div class="row g-5 align-items-start">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="cmsh-upload-zone" id="dropZone"
                            ...
                            <div class="cmsh-upload-label">Click to upload or drag & drop</div>
                            <div class="cmsh-upload-sub">PNG, JPG, JPEG, WEBP · Max 5MB</div>
                            <div class="cmsh-file-chosen" id="fileChosenText">
                                <i class="bi bi-check-circle-fill me-1"></i><span id="fileNameSpan"></span>
                            </div>
                        ...
                        @error('image')
                            <div class="cmsh-field-error"><i class="bi bi-exclamation-circle-fill"></i> {{ $message }}</div>
                        @enderror
                    </div>

                    {{-- Header Name --}}
                    <div class="col-lg-6">
                        <label class="cmsh-label">Header Name</label>
                        <div class="cmsh-select-wrap">
                            <select class="cmsh-select" name="name" required>
                                <option value="">Select header</option>
                                @for($i = 1; $i <= 7; $i++)
                                    <option value="Header {{ $i }}" {{ old('name') == "Header $i" ? 'selected' : '' }}>
                                        Header {{ $i }}
                                    </option>
                                @endfor
                            </select>
                ...
                <div class="d-flex justify-content-center gap-3">
                    <a href="{{ route('cmsheader.index') }}" class="cmsh-cancel-btn">Cancel</a>

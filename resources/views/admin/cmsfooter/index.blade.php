...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <span class="cmsh-page-title">Footer List</span>
        </div>
        <a href="{{ route('cmsfooter.create') }}" class="cmsh-add-btn">
            <i class="bi bi-plus-lg"></i> Add New Footer
        </a>
    </div>
    ...
    <div class="cmsh-card card">
        <div class="card-body p-0">
            ...
            <div class="cmsh-toolbar">
                ...
                {{-- Show per page --}}
                <form method="GET" action="{{ route('cmsfooter.index') }}" class="d-flex align-items-center">
                ...
                {{-- Search --}}
                <form method="GET" action="{{ route('cmsfooter.index') }}" class="cmsh-search-wrap">
            ...
            <div class="table-responsive">
                <table class="table cmsh-table mb-0">
                    ...
                    <tbody>
                        @forelse($cmsFooters as $i => $header)
                        <tr>
                            <td>
                            ...
                            <td><span class="cmsh-sl">{{ $cmsFooters->firstItem() + $i }}</span></td>
                            <td>
                                @if($header->image)
                                    ...
                                    <ul class="dropdown-menu cmsh-dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item cmsh-dropdown-item"
                                               href="{{ route('cmsfooter.edit', $header->id) }}">
                                                <i class="bi bi-pencil-square text-primary"></i> Edit
                                            </a>
                                        </li>
                                        <li>
                                            <form action="{{ route('cmsfooter.destroy', $header->id) }}"
                                                  method="POST"
...
{{-- Bulk Delete Form --}}
<form id="bulkDeleteForm" action="{{ route('cmsfooter.bulkDestroy') }}" method="POST">
    @csrf @method('DELETE')

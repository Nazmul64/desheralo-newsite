...
.edit-card h5 { font-size: 16px; font-weight: 700; margin-bottom: 22px; }
...
<div class="container-fluid px-3 px-md-4">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb mb-0" style="font-size:13px;">
            ...
            <li class="breadcrumb-item active">Edit Header #{{ $header->id }}</li>
        </ol>
    </nav>
    ...
    <div class="edit-card">
        ...
        <form id="editHeaderPageForm"
            action="{{ route('admin.headercode.update', $header->id) }}"
            ...
            <div class="mb-4">
                ...
                <input type="text"
                    ...
                    value="{{ old('google_analytics', $header->google_analytics) }}"
            ...
            <div class="mb-4">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox"
                        name="status" value="1" id="statusToggle"
                        {{ $header->status ? 'checked' : '' }}>
                    <label class="form-check-label" for="statusToggle" style="font-size:13px;">Active</label>
                </div>
            </div>
            ...
            <div class="d-flex gap-2">
                ...
                <button type="submit" class="btn btn-primary w-50" id="editPageSubmitBtn">
                    <span id="editPageBtnTxt">Update</span>
                    <span id="editPageSpinner" class="spinner-border spinner-border-sm ms-1 d-none"></span>
                </button>
            </div>
        </form>
    </div>
...
document.getElementById('editHeaderPageForm').addEventListener('submit', function(e) {
    e.preventDefault();
    ...
    btn.disabled = true; txt.textContent = 'Updating...'; spin.classList.remove('d-none');
    ...
    .then(r => r.json())
    .then(d => {
        btn.disabled = false; txt.textContent = 'Update'; spin.classList.add('d-none');
        if (d.success) {
